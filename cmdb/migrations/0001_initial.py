# Generated by Django 3.0.5 on 2020-04-04 08:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idc', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.IDC', verbose_name='IDC机房')),
                ('tag', models.ManyToManyField(to='cmdb.Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nic', to='cmdb.Server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='memory', to='cmdb.Server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('asset_obj', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.Server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='disk', to='cmdb.Server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('asset_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ar', to='cmdb.Server')),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.UserProfile')),
            ],
            options={
